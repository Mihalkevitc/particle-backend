...
- При каждом GET запросе к пресету увеличивается счётчик просмотров (ограничение для авт. и неавт.(по ip-адресу) пользователей - счётчик просмотров перестаёт инкриментроваться при >10 просмотра на пользователя за последние 5 минут)
