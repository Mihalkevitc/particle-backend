import { Controller, Post, Delete, Param, HttpCode, HttpStatus, UseGuards } from '@nestjs/common';
...
export class LikesController {
  ...
  async like(@Param('presetId') presetId: string, @GetUser() user: User): Promise<void> {
  ...
  async unlike(@Param('presetId') presetId: string, @GetUser() user: User): Promise<void> {
