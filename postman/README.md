...
- /tests/ `Particle_API_Tests.postman_collection.json` — коллекция для автоматизированного тестирования
...
## Коллекция для автоматизированного тестирования (`Particle_API_Tests.postman_collection.json`)

Коллекция содержит автотесты с проверкой статусов ответов и структуры данных.

### Запуск через Postman Runner

1. Открой коллекцию `Particle API Tests`
2. Нажми `Run`
3. Выбери окружение `Particle_API_Environment`
4. Нажми `Run Particle API Tests`
...
1) Настройка параметров тестирования:
